...
class NewOdinDataAdapter(ApiAdapter):
    """
    ...
    def __init__(self, **kwargs):
        ...
        :param kwargs:
        """
        super(NewOdinDataAdapter, self).__init__(**kwargs)
        ...
        self._controller = OdinDataController(self.name, self._endpoint_arg, self._update_interval)
