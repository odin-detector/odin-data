...
class NewFrameProcessorAdapter(ApiAdapter):
    """
    ...
    def __init__(self, **kwargs):
        ...
        :param kwargs:
        """
        super(NewFrameProcessorAdapter, self).__init__(**kwargs)
    ...
    def initialize(self, adapters):
        ...
        if self._fp_adapter_name in adapters:
            ...
            logging.info("FP adapter initiated connection to OdinData raw adapter: {}".format(self._fp_adapter_name))
        else:
            logging.error("FP adapter could not connect to the OdinData raw adapter: {}".format(self._fp_adapter_name))
    ...
    def get(self, path, request):
        ...
        try:
            ...
            response = {'response': 'OdinDatatAdapter GET error: {}'.format(param_error)}
            status_code = 400
