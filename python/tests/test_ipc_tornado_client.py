...
class TestIpcTornadoClient(TestCase):
    def test_ipc_tornado_client(self, tornado_channel):
        ...
        self.assertEqual(client._ip_address, "1.1.1.1")
        ...
        self.assertEqual(client.parameters["version"], "1.0.0")
        ...
        client._callback([reply_str])
        self.assertEqual(client.parameters["config"], {"test_config_item": "Test1"})
        ...
        self.assertEqual(client.check_for_rejection(4), True)
        ...
        self.assertEqual(client.parameters["status"]["error"], ["test error"])
