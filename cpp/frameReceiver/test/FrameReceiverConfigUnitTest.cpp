...
#define BOOST_TEST_MODULE "FrameReceiverConfigTests"
...
BOOST_AUTO_TEST_CASE(ValidSensorNameToTypeMapping)
{
    ...
    // TODO:    BOOST_CHECK_EQUAL(theConfig.map_sensor_name_to_type(p2mName),
    // FrameReceiver::Defaults::SensorTypePercival2M);
    // TODO:    BOOST_CHECK_EQUAL(theConfig.map_sensor_name_to_type(p13mName),
    // FrameReceiver::Defaults::SensorTypePercival13M);
    // TODO:    BOOST_CHECK_EQUAL(theConfig.map_sensor_name_to_type(excaliburName),
    // FrameReceiver::Defaults::SensorTypeExcalibur);
    // TODO:    BOOST_CHECK_EQUAL(theConfig.map_sensor_name_to_type(badName),
    // FrameReceiver::Defaults::SensorTypeIllegal);
}
