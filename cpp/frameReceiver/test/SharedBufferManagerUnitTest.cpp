...
BOOST_AUTO_TEST_CASE(BasicSharedBufferTest)
{
    ...
    BOOST_CHECK_NE(buf_address, nullptr);
...
BOOST_AUTO_TEST_CASE(SharedWithChildProcessTest)
{
    ...
    if (pid == 0) {
        ...
        BOOST_CHECK_NE(child_buf_address, nullptr);
...
BOOST_AUTO_TEST_CASE(MapMissingSharedBufferTest)
{
    ...
    BOOST_CHECK_THROW(
        OdinData::SharedBufferManager illegal_manager("ThisIsNotShared"), OdinData::SharedBufferManagerException
    );
}
...
{
    BOOST_CHECK_THROW(
        OdinData::SharedBufferManager illegal_manager("BadSize", 100, 1000), OdinData::SharedBufferManagerException
    );
}
...
{
    BOOST_CHECK_THROW(
        OdinData::SharedBufferManager illegal_manager("ZeroBufferSize", 100, 0), OdinData::SharedBufferManagerException
    );
}
...
{
    BOOST_CHECK_THROW(
        OdinData::SharedBufferManager illegal_manager("ZeroSharedMemSize", 0, 1000),
