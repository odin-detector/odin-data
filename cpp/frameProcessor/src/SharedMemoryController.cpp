 ...
 * tx_channel_ is a ZeroMQ plublisher that sends notifications (of released frames to
 * the frame receiver).
 *
        ...
        shared_buffer_config_request_deferred_(false)
{
  ...
  reactor_->register_channel(rx_channel_, std::bind(&SharedMemoryController::handleRxChannel, this));
