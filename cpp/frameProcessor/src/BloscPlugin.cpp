...
{
  add_config_param_metadata(CONFIG_BLOSC_COMPRESSOR, PMDD::UINT_T, PMDA::READ_WRITE, 0, 5);
  ...
  add_config_param_metadata(CONFIG_BLOSC_SHUFFLE, PMDD::UINT_T, PMDA::READ_WRITE, 0, 2);
