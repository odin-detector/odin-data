...
{
  add_config_param_metadata(CONFIG_BLOSC_COMPRESSOR, "int", "rw", {BLOSC_BLOSCLZ, BLOSC_LZ4, BLOSC_LZ4HC, BLOSC_SNAPPY, BLOSC_ZLIB, BLOSC_ZSTD});
  add_config_param_metadata(CONFIG_BLOSC_THREADS, "int", "rw", 1, ParamMetadata::MAX_UNSET);
  add_config_param_metadata(CONFIG_BLOSC_LEVEL, "int", "rw", 1, 9);
  add_config_param_metadata(CONFIG_BLOSC_SHUFFLE, "int", "rw",  {BLOSC_NOSHUFFLE, BLOSC_SHUFFLE, BLOSC_BITSHUFFLE});

  add_status_param_metadata(CONFIG_BLOSC_COMPRESSOR, "int", "rw", {BLOSC_BLOSCLZ, BLOSC_LZ4, BLOSC_LZ4HC, BLOSC_SNAPPY, BLOSC_ZLIB, BLOSC_ZSTD});
  add_status_param_metadata(CONFIG_BLOSC_THREADS, "int", "rw", 1, ParamMetadata::MAX_UNSET);
  add_status_param_metadata(CONFIG_BLOSC_LEVEL, "int", "rw", 1, 9);
  add_status_param_metadata(CONFIG_BLOSC_SHUFFLE, "int", "rw",  {BLOSC_NOSHUFFLE, BLOSC_SHUFFLE, BLOSC_BITSHUFFLE});
