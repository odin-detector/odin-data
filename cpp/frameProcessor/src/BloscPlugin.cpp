...
current_acquisition_(""), data_buffer_ptr_(NULL), data_buffer_size_(0)
{
  ...
  add_config_param_metadata(CONFIG_BLOSC_LEVEL, PMD::INT_T, PMD::READ_WRITE, 1, 9);
  add_config_param_metadata(CONFIG_BLOSC_SHUFFLE, PMD::UINT_T, PMD::READ_WRITE,  {BLOSC_NOSHUFFLE, BLOSC_SHUFFLE, BLOSC_BITSHUFFLE});

  add_status_param_metadata(CONFIG_BLOSC_COMPRESSOR, PMD::UINT_T, PMD::READ_WRITE, {BLOSC_BLOSCLZ, BLOSC_LZ4, BLOSC_LZ4HC, BLOSC_SNAPPY, BLOSC_ZLIB, BLOSC_ZSTD});
  add_status_param_metadata(CONFIG_BLOSC_THREADS, PMD::UINT_T, PMD::READ_WRITE, 1, ParamMetadata::MAX_UNSET);
  add_status_param_metadata(CONFIG_BLOSC_LEVEL, PMD::INT_T, PMD::READ_WRITE, 1, 9);
  add_status_param_metadata(CONFIG_BLOSC_SHUFFLE, PMD::UINT_T, PMD::READ_WRITE,  {BLOSC_NOSHUFFLE, BLOSC_SHUFFLE, BLOSC_BITSHUFFLE});
