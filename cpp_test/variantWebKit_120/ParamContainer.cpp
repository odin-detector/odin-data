...
template <> void ParamContainer::get_value(int& param, rapidjson::Value& value_obj) const { value_obj.SetInt(param); }
...
template <> void ParamContainer::get_value(bool& param, rapidjson::Value& value_obj) const { value_obj.SetBool(param); }
