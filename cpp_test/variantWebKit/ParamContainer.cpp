...
template <>
void ParamContainer::set_value(int& param, rapidjson::Value& value_obj) const
{
    param = value_obj.GetInt();
}

template <>
void ParamContainer::get_value(int& param, rapidjson::Value& value_obj) const
{
    value_obj.SetInt(param);
}

template <>
void ParamContainer::set_value(unsigned int& param, rapidjson::Value& value_obj) const
{
    param = value_obj.GetUint();
}

template <>
void ParamContainer::get_value(unsigned int& param, rapidjson::Value& value_obj) const
{
    value_obj.SetUint(param);
}

template <>
void ParamContainer::set_value(uint16_t& param, rapidjson::Value& value_obj) const
{
    param = value_obj.GetUint();
}

template <>
void ParamContainer::get_value(uint16_t& param, rapidjson::Value& value_obj) const
{
    value_obj.SetUint(param);
}
...
template <>
void ParamContainer::set_value(unsigned long& param rapidjson::Value& value_obj) const
{
    param = value_obj.GetUint64();
}

template <>
void ParamContainer::get_value(unsigned long& param, rapidjson::Value& value_obj) const
{
...
template <>
void ParamContainer::set_value(int64_t& param, rapidjson::Value& value_obj) const
{
    param = value_obj.GetInt64();
}

template <>
void ParamContainer::get_value(int64_t& param, rapidjson::Value& value_obj) const
{
    value_obj.SetInt64(param);
}

template <>
void ParamContainer::set_value(uint64_t& param, rapidjson::Value& value_obj) const
{
    param = value_obj.GetUint64();
}

template <>
void ParamContainer::get_value(uint64_t& param, rapidjson::Value& value_obj) const
{
    value_obj.SetUint64(param);
}

template <>
void ParamContainer::set_value(double& param, rapidjson::Value& value_obj) const
{
    param = value_obj.GetDouble();
}

template <>
void ParamContainer::get_value(double& param, rapidjson::Value& value_obj) const
{
    value_obj.SetDouble(param);
}

template <>
void ParamContainer::set_value(std::string& param, rapidjson::Value& value_obj) const
{
    param = value_obj.GetString();
}

template <>
void ParamContainer::get_value(std::string& param, rapidjson::Value& value_obj) const
{
    value_obj.SetString(rapidjson::StringRef(param.c_str()));
}

template <>
void ParamContainer::set_value(bool& param, rapidjson::Value& value_obj) const
{
    param = value_obj.GetBool();
}

template <>
void ParamContainer::get_value(bool& param, rapidjson::Value& value_obj) const
{
    value_obj.SetBool(param);
}

template <>
void ParamContainer::set_value(ParamContainer::Document& param, rapidjson::Value& value_obj) const
{
    param.CopyFrom(value_obj, param.GetAllocator());
}

template <>
void ParamContainer::get_value(ParamContainer::Document& param, rapidjson::Value& value_obj) const
{
